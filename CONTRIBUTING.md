# transp-or/Robust_Railway Contributing Guide

Hi! Thanks for taking the time to contribute to transp-or/Robust_Railway.

_You can contribute in many ways_

- Join the [discussion](https://github.com/transp-or/Robust_Railway/discussions)

_Before submitting your contribution, please make sure to take a moment and read through the following guidelines_

- [Code of Conduct](https://github.com/transp-or/Robust_Railway/blob/main/CODE_OF_CONDUCT.md)
...
- Always use [ issue templates ](https://github.com/transp-or/Robust_Railway/issues/new/choose)
